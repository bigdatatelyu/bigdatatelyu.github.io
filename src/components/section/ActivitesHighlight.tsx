        ...
        <CarouselContent>
          {activities.map((a, i) => (
            <CarouselItem key={i}>
              ...
              >
                <h3 className="text-xl font-bold text-slate-800 dark:text-green-100">
                  {a.title}
                </h3>
                <p className="mt-2 text-sm text-slate-500 dark:text-green-200">
                  {a.date}
                </p>
                <p className="mt-4 text-slate-700 dark:text-green-300">
                  {a.desc}
                </p>
                <span className="mt-5 inline-block text-sm font-semibold text-emerald-600 transition group-hover:underline dark:text-emerald-400">
                  Lihat Selengkapnya →
                </span>
              </motion.div>
            </CarouselItem>
